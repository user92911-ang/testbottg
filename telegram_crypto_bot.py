...
def main():
    ...
    TELEGRAM_TOKEN = "8413183702:AAEGs7UPQDsz9CmmcCqLpfBZApFrp1I6el0"
    
    if TELEGRAM_TOKEN == "8413183702:AAEGs7UPQDsz9CmmcCqLpfBZApFrp1I6el0":
        print("Please set your Telegram bot token in the TELEGRAM_TOKEN variable")
